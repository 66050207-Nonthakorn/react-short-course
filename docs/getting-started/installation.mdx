...
ในส่วนของหน้านี้จะสอนการติดตั้งสิ่งที่ต้องใช้ทั้งหมด ในการสร้างเว็บ React
